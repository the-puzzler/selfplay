"""Train self-play PPO on the dogfight env.

Usage:
  uv run python -m dogfight.train --reset-mode diverse --out runs/dog-v0
...
from dogfight.env import DogfightEnv
from dogfight.ppo import DEFAULT_CFG, make_train_iter
...
def main():
    ...
    p.add_argument("--out", type=str, default="runs/dog-dev")
    args = p.parse_args()
