...
Usage:
  uv run python -m nidhogg.train --reset-mode diverse --out runs/nid-v1
Dashboard: uv run python -m fighter2d.plot --run runs/nid-v1
"""
...
from nidhogg.env import EPISODE_LEN, NidhoggEnv
from nidhogg.grpo import DEFAULT_CFG, make_train_iter
...
def main():
    ...
    p.add_argument("--out", type=str, default="runs/nid-dev")
    args = p.parse_args()
