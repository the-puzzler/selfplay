"""GRPO self-play for the Nidhogg env (discrete actions, no critic).
...
from nidhogg.env import ACT_DIM, EPISODE_LEN, OBS_DIM, NidhoggEnv
...
def make_train_iter(env: NidhoggEnv, cfg):
    network = Policy()
